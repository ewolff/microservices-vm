Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 2003, host: 2003     # Carbon for Graphite
  config.vm.network "forwarded_port", guest: 8082, host: 8082     # Graphite Web for Graphite
  config.vm.network "forwarded_port", guest: 8083, host: 8083     # User Registration for Graphite
